...
import { ChecklistItem } from '../interfaces/checklist-items';
...
export class ChecklistPage implements OnInit {
  ...
  constructor(private alertCtrl: AlertController, private route: ActivatedRoute, private checklistService: ChecklistService) { }
  ...
  async renameItem(item:ChecklistItem):Promise<void>{
    const alert = await this.alertCtrl.create({
      header: "Rename Item",
      message: "Enter the new name of the item",
      inputs: [
        {
          type: 'text',
          name: 'name',
